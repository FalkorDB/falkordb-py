...
class TestParseScalarFunctions:
    ...
    def test_parse_node(self):
        ...
        # Node format: [node_id, [label_ids],
        # [[prop_id, scalar_type, scalar_value], ...]]
        value = [
            ResultSetScalarTypes.VALUE_NODE.value,
            [
                1,  # node_id
                [0],  # label_ids
                [
    ...
    def test_parse_edge(self):
        ...
        # Edge format: [edge_id, relation_id, src_node_id, dest_node_id,
        # [[prop_id, scalar_type, scalar_value], ...]]
        value = [
            ResultSetScalarTypes.VALUE_EDGE.value,
            [
                1,  # edge_id
                0,  # relation_id
                2,  # src_node_id
    ...
    def test_parse_path(self):
        ...
        value = [
            ResultSetScalarTypes.VALUE_PATH.value,
            [
                [
                    ResultSetScalarTypes.VALUE_ARRAY.value,
                    [
